          ...
          <div className="flex-1">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <button
                ...
                style={{ border: '1.5px solid rgba(255,255,255,0.3)', color: 'white', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
          {categories.map(cat => (
            <button key={cat.id}
              ...
              style={{ border: '1.5px solid rgba(113,188,104,0.15)', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <section className="max-w-5xl mx-auto px-6 pb-10">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-bold text-lg flex items-center gap-2" style={{ color: '#0A4C3E', fontFamily: 'Sora, sans-serif' }}>
              <Star size={18} color="#71BC68" fill="#71BC68" />
              Terlaris
            </h2>
        ...
        <div className="relative overflow-hidden rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-6"
          ...
          <div className="hidden md:flex flex-col gap-3">
            {[
              ...
              <div key={item} className="text-sm font-medium px-4 py-2 rounded-xl"
